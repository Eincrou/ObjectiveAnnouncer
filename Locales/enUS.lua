...
L["qsebonusobj"] = "Bonus Objective"
L["qsebonusobjdesc"] = "Send an extra announcement when you enter a Bonus Objective area.|n|cFF9ffbffWill not announce unless you receive the bonus objective quest."
